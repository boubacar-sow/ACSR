...
def train_model(model, train_loader, val_loader, optimizer, num_epochs, alpha, device):
    ...
    best_val_per = 0.155 # Start with a very high value
    ...
    for epoch in range(num_epochs):
        ...
        if val_per < best_val_per:
            ...
            model_save_path = f"/pasteur/appa/homes/bsow/ACSR/src/acsr/saved_models/gridsearch/new_feat_model_decoding_retrained{args.learning_rate}_{args.alpha}_{args.encoder_hidden_dim}_{args.n_layers}_{args.optimizer}.pt"
            optimizer_save_path = f"/pasteur/appa/homes/bsow/ACSR/src/acsr/saved_models/gridsearch/new_feat_optimizer_decoding_retrained2_{args.learning_rate}_{args.alpha}_{args.encoder_hidden_dim}_{args.n_layers}_{args.optimizer}.pt"
...
if __name__ == "__main__":
    ...
    torch.save(acoustic_model.state_dict(), f"/pasteur/appa/homes/bsow/ACSR/src/acsr/saved_models/gridsearch/new_feat_model_decoding_last_retrained_{args.learning_rate}_{args.alpha}_{args.encoder_hidden_dim}_{args.n_layers}_{args.optimizer}.pt")
