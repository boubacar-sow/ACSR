...
def train_model(model, train_loader, val_loader, optimizer, num_epochs, alpha, device):
    ...
    for epoch in range(num_epochs):
        ...
        if val_per < best_val_per:
            ...
            model_save_path = f"/pasteur/appa/homes/bsow/ACSR/src/acsr/saved_models/model_decoding_no_attention.pt"
...
if __name__ == "__main__":
    ...
    torch.save(acoustic_model.state_dict(), "/pasteur/appa/homes/bsow/ACSR/output/saved_models/model_final_no_attention.pth")
